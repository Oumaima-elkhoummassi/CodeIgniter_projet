                                        ...
                                        <?php if($client): ?>
                                            <?php foreach($client as $row): ?>
                                                <tr>
                                                    ...
                                                    <a href="<?= site_url('client/delete/' . $row['id']) ?>" class="btn btn-square btn-primary m-2" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?');"><i class="fa fa-trash"></i></a>
